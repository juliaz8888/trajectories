...
for i = 1:100
     % trajs = {traj1, traj2, traj3, traj4, traj5, traj6, traj7, traj8};
     try 
...
for itr = 1:1 % change to however many generation rates, but this will plot a bunch of figures
    ...
    x_traj = x_traj - min(traj1(:,1)) * 1e4; % change for each trajectory
    y_traj = y_traj - min(traj1(:,2)) * 1e4;
    z_traj = z_traj - min(traj1(:,3)) * 1e4;
